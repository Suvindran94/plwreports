...
<head>
    ...
    <title>PLW IERP Daily Reports</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../plw.png" />
                ...
                <div class="app-brand demo">
                    <a href="index.html" class="app-brand-link">
                        <span class="app-brand-logo demo">
                            <img src="images/b&w_color.png" style="width:200px; height:60px;" />
                        </span>
                    </a>
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);"
                                    ...
                                    <div class="avatar avatar-online">
                                        <img src="https://ierp.tk/uploads/avatars/{{ Auth::user()->profImage }}" alt
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                            ...
                                            <div class="d-flex">
                                                <div class="flex-shrink-0 me-3">
                                                    <div class="avatar avatar-online">
                                                        ...
                                                        <img src="https://ierp.tk/uploads/avatars/{{ Auth::user()->profImage }}"
                                                            alt class="w-px-40 h-auto rounded-circle" />
                                                    </div>
                                                </div>
                                                <div class="flex-grow-1">
                                                    <span class="fw-semibold d-block">{{ auth()->user()->fname }}</span>
                                                    <small class="text-muted">IERP User</small>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="/ierphome">
