            ...
            function initializeDataTable() {
                return $('#datatable').DataTable({
                    ...
                    rowCallback: function(row, data) {
                        ...
                        console.log('rowCallback - currentHour:', currentHour); // Log current hour in rowCallback
                    ...
                    createdRow: function(row, data) {
                        var currentHour = getCurrentHour();
                        console.log('createdRow - currentHour:', currentHour); // Log current hour in createdRow
